...
module.exports = function loadSailsStdlibPg (slug, overrides){
  ...
  var pg = (function _gettingAppropriatePackage(){
    switch (slug.toLowerCase()) {
      ...
      // Any Occasion
      case 'strings':
        return _.pick(require('machinepack-strings'), [
          'ensureUniq',
          'random',
          'toStream',
          'uuid'
        ...
        //   name: 'stdlib(\'strings\')',
        //   defs: {
        //     ensureUniq: require('./private/strings/ensure-uniq'),
        //     random: require('./private/strings/random'),
        //     toStream: require('./private/strings/to-stream'),
        //     uuid: require('./private/strings/uuid')
        //   }
        // });
      ...
      case 'fs':
        return _.pick(require('machinepack-fs'), [
          'cp',
          'ensureDir',
          'exists',
          'ls',
      ...
      case 'http':
        return _.pick(require('machinepack-http'), [
          'del',
          'getStream',
          'get',
          'patch',
      ...
      case 'process':
        return _.pick(require('machinepack-process'), [
          'executeCommand'
        ]);
