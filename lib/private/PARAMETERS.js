...
module.exports = {
  ...
  AI_SECRET: {
    type: 'string',
    required: true,
    friendlyName: 'OpenAI/xAI secret',
    description: 'The secret API key from a valid OpenAI/xAI developer account, or a secret from a compatible API such as Anthropic, Google, IBM, etc.',
    extendedDescription: 'Like any other input, this can be set globally using .configure().',
    ...
    whereToGet: {
      ...
      description: 'Generate an API key in your OpenAI/xAI dashboard.',
      extendedDescription: 'To generate an API key, you will first need to log in to your OpenAI/xAI/etc account, or sign up for one if you have not already done so.'
    }
  },
  ...
  AI_API_URL: {
    type: 'string',
    required: false,
    friendlyName: 'OpenAI/xAI API base URL',
    description: 'The URL of the large language model (LLM) for sending prompts.',
    extendedDescription: 'Like any other input, this can be set globally using .configure(). If this is not set, by default, the best guess will be attempted based on available information.',
    defaultsTo: 'https://api.openai.com/v1/chat/completions',
    whereToGet: {
      url: 'https://platform.openai.com/docs/api-reference/chat/create',
      description: 'The URL of the API endpoint where prompts will be posted.',
    }
  }
