...
module.exports = {
  ...
  STRIPE_CUSTOMER_ID: {
    description: 'The ID of an existing Stripe customer entry.',
  ...
  STRIPE_PAY_PLAN_ID: {
    description: 'The ID of one of your recurring billing subscription plans.',
    example: 'pro',
    whereToGet: {
  ...
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  // FUTURE: Maybe bring this back eventually:
  // ```
