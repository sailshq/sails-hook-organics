module.exports = {
  ...
  moreInfoUrl: 'https://stripe.com/docs/api#create_customer',


  // TODO: Probably merge into update-customer
  // (making it like the "identify" method sometimes offered by analytics platforms)
  // (though Stripe is a bit different in that there's no way to hard-code the user id
  // from the userland end-- you have to use Stripe's actual customer ids)
  inputs: {
    ...
    description: {
      ...
      extendedDescription: 'This will be shown in the Stripe dashboard.',
      type: 'string',
      example: 'Phyllis Willis  (signed up after visiting our Black Friday 2021 promotional landing page)'
    },
  ...
  exits: {
    ...
    success: {
      ...
      moreInfoUrl: 'https://dashboard.stripe.com/test/customers'
    }
