module.exports = {
  ...
  // https://stripe.com/docs/api#event_types-plan.created

  Stripe.enrollCustomer({
    stripeCustomerId: '',
    emailAddress: 'gaasddgs',
    stripeDescription: 'gaasddgs',
  });

  Stripe.declareCustomer({
    stripeCustomerId: '',
    emailAddress: 'gaasddgs',
    stripeDescription: 'gaasddgs',
  });
  ...
  Stripe.relayCustomer({
    customerId: '',
    payPlanId: ''
    billingEmailAddress:
    emailAddress: 'gaasddgs',
    customerDescription: 'gaasddgs',
  });
  ...
  // · Set billing email (for receipts/refunds/chargebacks)
  ...
  // · Add credit card
  // · Remove credit card
  // · Switch default credit card
  Stripe.setBillingInfo({
    billingId: '',
    payPlanId: ''
    billingEmailAddress:
    emailAddress: 'gaasddgs',
  ...
  Stripe.relayCustomerUpdate()
  // customer.created
  //  https://stripe.com/docs/api#event_types-customer.created
  // customer.updated
  //  https://stripe.com/docs/api#event_types-customer.updated
