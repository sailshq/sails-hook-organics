...
module.exports = {
  ...
  sendgrid: {
    description: 'Communicate with the SendGrid API to send automated emails.',
    methodIdts: [
      'send-html-email'
    ]
  },
  ...
  twilio: {
    description: 'Communicate with the Twilio API to send SMS.',
    methodIdts: [
      'send-text-message'
    ]
  },
  // ai: {
  //   description: 'Communicate with the OpenAI API or other similar LLMs to send prompts.',
  //   methodIdts: [
  //     'prompt',
  //     'decide',
  //     'weigh',
