module.exports = {
  ...
  inputs: {
    ...
    useHttps: {
      type: 'boolean',
      description: 'Whether to build a secure URL ("https://".)',
      extendedDescription: 'If `false` is explicitly specified, the resulting URL will start with "http://".  But otherwise, it uses https://, which is the right choice 99.9% of the time.',
      defaultsTo: true
    }
